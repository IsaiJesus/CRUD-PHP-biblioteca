          ...
          <section class="d-flex flex-column py-4 px-5">
            ...
            >
              <div class="d-flex align-items-center form-submit">
                <span class="fas fa-graduation-cap fs-1 pe-3"></span>
                <h1 class="m-0">Alumnos</h1>
              </div>
              <a href="new-alumno.html" class="btn btn-primary btn-lg fs-6">
            ...
            <div class="row mt-4">
              <div
                ...
                "
              >
                <h3 class="no-books fs-2">No hay alumnos agregados.</h3>
                <h5 class="no-books fs-4">
                  Agrega un alumno cuando este requiera de un libro.
                </h5>
              </div>
              <div class="col-6">
                <img src="images/student.png" alt="Alumno" width="480" />
              </div>
            </div>
            <?php }else{ ?>
            ...
            <div class="row mt-4">
              <?php
                ...
                $result_alumnos = mysqli_query($conn, $sql);
              ...
              <div class="col-4 p-2">
                <div class="card bg-light">
                  <div class="card-header bg-light">
                    <h5 class="card-title">
                      <?php
                        echo $row['name_student']
                      ?>
                    </h5>
                    <p class="card-text mb-1">
                      <?php echo $row['grade_student'] ?>°
                      "<?php echo $row['group_student'] ?>"
                  ...
                  <div class="card-body d-flex justify-content-between">
                    <a
                      href="edit_alumno.php?id=<?php echo $row['id_estudiante'] ?>"
                    ...
                    <a
                      href="delete_alumno.php?id=<?php echo $row['id_estudiante'] ?>"
