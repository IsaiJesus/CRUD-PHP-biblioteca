<?php
    ...
    if(isset($_GET['id'])) {
        ...
        if(mysqli_num_rows($result) == 1) {
            ...
            $grade_student = $row['grade_student'];
            $group_student = $row['group_student'];
            $especialidad = $row['especialidad'];
            $book_student = $row['id_libro'];
        }
    }
    ...
    if(isset($_POST['update'])) {
        ...
        $sql = "UPDATE estudiantes SET name_student = '$name', 
        grade_student = '$grade_student', group_student = '$group_student', 
        especialidad = '$especialidad', id_libro = '$book_student' WHERE id_estudiante = $id";
          ...
          <div class="d-flex flex-column py-4 px-5">
            ...
            >
              <div class="d-flex align-items-center form-submit">
                ...
                <h1 class="m-0 fs-2">Editar alumno</h1>
              </div>
            </header>
          </div>
          <form
            action="edit_alumno.php?id=<?php echo $_GET['id']; ?>"
            method="POST"
          ...
          >
            <div class="d-flex flex-column border rounded p-4">
              <input
                ...
                type="text"
                value="<?php echo $name; ?>"
                placeholder="Actualiza el nombre del alumno"
                required
                class="
                  mb-3
                  border border-dark
              ...
              <input
                name="grade_student"
                type="number"
                value="<?php echo $grade_student; ?>"
                placeholder="Actualiza el grado del alumno"
                required
                class="
                  mb-3
                  border border-dark
              ...
              <input
                name="group_student"
                type="text"
                value="<?php echo $group_student; ?>"
                placeholder="Actualiza el grupo del alumno"
                required
                class="
                  mb-3
                  border border-dark
              ...
              <input
                ...
                placeholder="Actualiza la especialidad del alumno"
                required
                class="
                  mb-3
                  border border-dark
              ...
              <input
                name="book_student"
                type="number"
                value="<?php echo $book_student; ?>"
                placeholder="Actualiza el libro prestado al alumno"
                required
                class="
                  mb-4
                  border border-dark
